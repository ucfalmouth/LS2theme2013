...
$THEME->sheets = array('moodle', 'editor', 'jquery.sidr.dark', 'learningspace', 'bootstrap', 'introjs');
...
$THEME->javascripts_footer = array('jquery','jquery.sidr.min','plugins','scripts');