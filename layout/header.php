    ...
    <header role="banner" class="navbar navbar-fixed-top">
        <nav role="navigation" class="navbar-inner navbar-inverse">
            <div class="container-fluid">
                ...
                <ul class="nav">
                    <li class="menu-item-resources"><a href="/course">Courses</a></li>
                ...
                <ul class="nav pull-right">
                    <li><i class="icon-search"></i><a href="http://learningspace.falmouth.ac.uk/theme/learningspace/pages/finder/course/course-finder.php">Course Finder</a></li>
