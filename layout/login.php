...
<header role="banner" class="navbar navbar-fixed-top">
    <nav role="navigation" class="navbar-inner navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav">
                    <!--<li><a class="menu-item-resources dropdown-toggle" data-toggle="dropdown" href="#">Resources</a>
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="dyslexia.fxplus.falmouth.ac.uk">Dyslexia Skills</a></li>
                            <li><a href="http://intranet.falmouth.ac.uk/html/finance/">Finance Services</a></li>
                            <li><a href="http://www.fxu.org.uk/">FXU</a></li>
                            <li><a href="mailto:international@falmouth.ac.uk?Subject=Enquiry">International Office</a></li>
                            ...
                            <li><a href="mailto:registry@falmouth.ac.uk?Subject=Enquiry">Registry</a></li>
                            <li><a href="/course/view.php?id=665">Results Release</a></li>
                            <li><a href="/category.php?id=59">Software Training</a></li>
            ...
            <!--<li><i class="icon-user"></i><?php echo $PAGE->headingmenu ?></li>
...
<?php if ($hasheader) { ?><div id="bannerimg" ><!--<img src="http://localhost:8888/moodle24/moodle/theme/learningspace/img/despicable_me_2_agnes-wallpaper-1920x1080.jpg" />--></div>
...
<div id="page-content" class="row-fluid">
    ...
    <section id="region-main" class="span4 offset4">
    ...
    <a style="float:right;" href="http://learningspace.falmouth.ac.uk/mod/choice/view.php?id=16064" class="btn"> Staff Learning Space Training </a>
    </div> -->




<!--<a class="work-here btn btn-primary pull-right" style="margin-top:80px" data-toggle="popover" data-placement="bottom" data-content="If you would like to display your work on the Learning Space front page, please get in touch with your module academic." data-original-title=""><i class="icon-heart"></i> Your work here?</a>-->
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-body">
    <iframe src="//player.vimeo.com/video/75034342" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe> 
  </div>
