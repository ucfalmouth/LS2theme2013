    ...
    public function login_info($withlinks = null) {
        ...
        if (empty($course->id)) {
            ...
            if ($withlinks) {
                ...
                $username = "<a class=\"dropdown-toggle\" data-toggle=\"dropdown\" href=\"$CFG->wwwroot/user/profile.php?id=$USER->id\" title=\"$linktitle\">$fullname <b class=\"caret\"></b></a>";
            } else {
                $username = $fullname;
            }
            ...
            if (isguestuser()) {
                ...
                if ($withlinks) {
                    ...
                    $dropdownitemmyprofile = "<li><a href=\"$CFG->wwwroot/user/profile.php?id=$USER->id\" title=\"$linktitle\"><i class=\"icon-user\"></i> My Profile</a></li>";

                    $dropdownitemhelp = "<li><a href=\"https://et.tenderapp.com/help/discussion/new\"><i class=\"icon-question-sign\"></i> Help</a></li>";

                    $dropdownitemstudentemail = "<li><a href=\"http://studentmail.falmouth.ac.uk/\"><i class=\"icon-envelope\"></i> Student Email</a></li>";

                    $dropdownitemstaffemail = "<li><a href=\"http://mailspace.falmouth.ac.uk/\"><i class=\"icon-envelope\"></i> Staff Email</a></li>";

                    $dropdownitemtimetable = "<li><a href=\"http://mytimetable.falmouth.ac.uk/\"><i class=\"icon-calendar\"></i> My Timetable</a></li>";

                    $dropdownitemlogout = "<li class=\"divider\"></li><li><a href=\"$CFG->wwwroot/login/logout.php?sesskey=".sesskey()."\"><i class=\"icon-off\"></i> ".get_string('logout').'</a></li>';
                    
                    $dropdownitems .= $dropdownitemtimetable.$dropdownitemmyprofile.$dropdownitemstudentemail.$dropdownitemstaffemail.$dropdownitemhelp.$dropdownitemlogout;
